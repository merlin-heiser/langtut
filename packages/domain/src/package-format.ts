...
export interface LearningActivity { id: string; title: string; description?: string; type?: "roleplay"; scenarioTarget?: string; scenarioSource?: string; roles: ActivityRole[]; turnOrder: string[]; rounds: number; focusTags?: string[]; moduleIds?: string[] }
