...
Wenn alle Notes importiert und alle Milestones mindestens einmal aktiv versucht
wurden, wechselt das Modul zu `learning`. Nachfolgemodule werden freigeschaltet,
unabhängig von Fehlerzahl oder Anki-Retention.
